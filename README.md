...
- **Android 7.0 is the floor**, where upstream still supports Android 6.0. The fork's `minSdk` is 24 rather than 23, because AndroidX Navigation requires it from 2.10.0 onward and staying behind would mean pinning a dependency the rest of the stack has moved past. Android 6.0 devices cannot install this fork.
