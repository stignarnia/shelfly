...
import xyz.stignarnia.uiMovie.MovieDetailsEvent.OpenPeopleSheet
import xyz.stignarnia.uiMovie.MovieDetailsEvent.OpenPersonSheet
...
import xyz.stignarnia.uiMovie.databinding.FragmentMovieDetailsPeopleBinding
import xyz.stignarnia.uiMovie.sections.people.recycler.ActorsAdapter
...
class MovieDetailsPeopleFragment : BaseFragment<MovieDetailsPeopleViewModel>(R.layout.fragment_movie_details_people) {
  ...
  private fun openPeopleSheet(event: OpenPeopleSheet) {
    ...
    val title =
      (requireParentFragment() as MovieDetailsFragment)
