...
import xyz.stignarnia.uiMovie.sections.collections.details.recycler.MovieDetailsCollectionItem.HeaderItem
import xyz.stignarnia.uiMovie.sections.collections.details.recycler.MovieDetailsCollectionItem.LoadingItem
import xyz.stignarnia.uiMovie.sections.collections.details.recycler.MovieDetailsCollectionItem.MovieItem
import xyz.stignarnia.uiMovie.sections.collections.details.recycler.views.MovieDetailsCollectionHeaderView
import xyz.stignarnia.uiMovie.sections.collections.details.recycler.views.MovieDetailsCollectionItemView
import xyz.stignarnia.uiMovie.sections.collections.details.recycler.views.MovieDetailsCollectionLoadingView
...
class MovieDetailsCollectionAdapter(
  ...
  override fun onCreateViewHolder(
    ...
    VIEW_TYPE_HEADER -> {
      BaseViewHolder(MovieDetailsCollectionHeaderView(parent.context))
    }

    VIEW_TYPE_LOADING -> {
      BaseViewHolder(MovieDetailsCollectionLoadingView(parent.context))
    }
