...
import xyz.stignarnia.uiBase.utilities.extensions.invisible
...
import xyz.stignarnia.uiBase.utilities.extensions.setTextFade
...
import xyz.stignarnia.uiEpisodes.databinding.ViewEpisodeDetailsBinding
import xyz.stignarnia.uiEpisodes.details.links.EpisodeLinksBottomSheet
...
class EpisodeDetailsBottomSheet : BaseBottomSheetFragment(R.layout.view_episode_details) {
  ...
  private fun openLinksSheet() {
    val bundle =
      EpisodeLinksBottomSheet.createBundle(
