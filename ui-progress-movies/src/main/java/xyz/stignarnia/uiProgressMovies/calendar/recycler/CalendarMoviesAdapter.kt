...
import xyz.stignarnia.uiProgressMovies.calendar.views.CalendarMoviesFiltersView
import xyz.stignarnia.uiProgressMovies.calendar.views.CalendarMoviesHeaderView
import xyz.stignarnia.uiProgressMovies.calendar.views.CalendarMoviesItemView
...
class CalendarMoviesAdapter(
  ...
  override fun onCreateViewHolder(
    ...
    VIEW_TYPE_HEADER -> {
      BaseViewHolder(CalendarMoviesHeaderView(parent.context))
    }
