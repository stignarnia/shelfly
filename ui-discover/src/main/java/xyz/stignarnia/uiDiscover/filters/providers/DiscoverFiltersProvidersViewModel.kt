...
import xyz.stignarnia.uiDiscover.filters.providers.DiscoverFiltersProvidersUiEvent.ApplyFilters
import xyz.stignarnia.uiDiscover.filters.providers.DiscoverFiltersProvidersUiEvent.CloseFilters
import xyz.stignarnia.uiModel.StreamingProvider
import javax.inject.Inject

@HiltViewModel
internal class DiscoverFiltersProvidersViewModel
  @Inject
  constructor(
    ...
    private fun loadProviders() {
      viewModelScope.launch {
        ...
        try {
          val providers =
            watchProvidersRepository.loadProviders(
              isMovie = false,
              countryCode = country,
            )
