package xyz.stignarnia.uiBackup.features.imports.migrations.model
 ...
 *
 * These models exist only to be read by [xyz.stignarnia.uiBackup.features.imports.migrations.BackupMigrationV2]; nothing else should depend on them.
 */
