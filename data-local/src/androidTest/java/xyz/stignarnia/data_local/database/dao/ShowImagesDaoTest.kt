...
class ShowImagesDaoTest : BaseDaoTest() {
  ...
  @Test
  fun shouldReturnImageByTypeForShow() =
    runBlocking {
  ...
  @Test
  fun shouldReturnImageByTypeForEpisode() =
    runBlocking {
