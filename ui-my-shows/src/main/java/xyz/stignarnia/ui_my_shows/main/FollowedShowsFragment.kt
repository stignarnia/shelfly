...
import xyz.stignarnia.ui_my_shows.databinding.FragmentFollowedShowsBinding
...
class FollowedShowsFragment :
  ...
  private fun setupPager() {
    with(binding) {
      ...
      tabsMediator = TabLayoutMediator(followedShowsTabs, followedShowsPager) { tab, position ->
