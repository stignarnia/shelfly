...
import xyz.stignarnia.uiMyShows.databinding.ViewShowsFiltersBinding
...
class CollectionShowFiltersView : FrameLayout {
  ...
  fun bind(
    ...
    with(binding) {
      ...
      followedShowsNetworksChip.text =
        when {
      ...
      followedShowsUpcomingChip.text =
        when (item.upcoming) {
