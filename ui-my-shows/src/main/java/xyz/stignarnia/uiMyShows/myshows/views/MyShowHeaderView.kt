...
import xyz.stignarnia.uiMyShows.databinding.ViewMyShowsHeaderBinding
...
class MyShowHeaderView : FrameLayout {
        ...
        myShowsGenresChip.text =
          when {
            ...
            genres.size == 2 -> {
              ...
              "${context.getString(genres[0].displayName)}, " +
  ...
  private fun bindLabel(item: MyShowsItem.Header) {
    ...
    binding.myShowsHeaderLabel.text =
      when (item.section) {
        RECENTS -> headerLabel
