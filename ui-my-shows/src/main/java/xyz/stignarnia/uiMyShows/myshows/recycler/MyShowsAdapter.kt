...
import xyz.stignarnia.uiMyShows.myshows.views.MyShowAllView
import xyz.stignarnia.uiMyShows.myshows.views.MyShowHeaderView
import xyz.stignarnia.uiMyShows.myshows.views.MyShowsRecentsView
...
class MyShowsAdapter(
  ...
  override fun onCreateViewHolder(
    ...
    VIEW_TYPE_HEADER -> {
      BaseViewHolder(MyShowHeaderView(parent.context))
    }

    VIEW_TYPE_RECENTS_SECTION -> {
      BaseViewHolder(MyShowsRecentsView(parent.context))
    }
