...
import xyz.stignarnia.uiModel.MyShowsSection.RECENTS
...
import xyz.stignarnia.uiMyShows.myshows.cases.MyShowsLoadShowsCase
import xyz.stignarnia.uiMyShows.myshows.cases.MyShowsRatingsCase
import xyz.stignarnia.uiMyShows.myshows.cases.MyShowsSortingCase
import xyz.stignarnia.uiMyShows.myshows.cases.MyShowsTranslationsCase
import xyz.stignarnia.uiMyShows.myshows.recycler.MyShowsItem
import xyz.stignarnia.uiMyShows.myshows.recycler.MyShowsItem.Type
    ...
    fun loadShows(resetScroll: List<Type>? = null) {
      ...
      loadItemsJob =
        viewModelScope.launch {
          ...
          val allShows =
            loadShowsCase.filterSectionShows(
              allShows = shows,
              allSeasons = seasons,
