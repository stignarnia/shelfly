...
import xyz.stignarnia.uiModel.UpcomingFilter.OFF
import xyz.stignarnia.uiModel.UpcomingFilter.RELEASED
import xyz.stignarnia.uiModel.UpcomingFilter.UPCOMING
import xyz.stignarnia.uiMyShows.common.recycler.CollectionListItem
import javax.inject.Inject
import javax.inject.Singleton

@Singleton
class WatchlistItemFilter
  @Inject
  constructor() {
    fun filterUpcoming(
