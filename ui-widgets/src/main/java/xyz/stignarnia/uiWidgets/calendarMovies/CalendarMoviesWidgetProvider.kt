...
class CalendarMoviesWidgetProvider : BaseWidgetProvider() {
  ...
  companion object {
    fun requestUpdate(context: Context) {
      ...
      val intent =
        Intent(applicationContext, CalendarMoviesWidgetProvider::class.java).apply {
          val ids: IntArray =
            AppWidgetManager
  ...
  private fun updateWidget(
    ...
    val listClickIntent =
      Intent(context, CalendarMoviesWidgetProvider::class.java).apply {
        action = ACTION_CLICK
      }
      ...
      fun remoteViews(items: RemoteViews.RemoteCollectionItems) =
        RemoteViews(context.packageName, getLayoutResId()).apply {
          ...
          applyWidgetChrome(
            ...
            context.getString(R.string.textWidgetMoviesCalendar),
          )
          setTextViewText(R.id.calendarWidgetMoviesEmptyViewTitle, context.getString(R.string.menuCalendar))
          palette.let {
