package xyz.stignarnia.uiWidgets.progress
...
class ProgressWidgetProvider : BaseWidgetProvider() {
  ...
  companion object {
    ...
    fun requestUpdate(context: Context) {
      ...
      val intent =
        Intent(applicationContext, ProgressWidgetProvider::class.java).apply {
          val ids: IntArray =
  ...
  private fun updateWidget(
    ...
    val listClickIntent =
      Intent(context, ProgressWidgetProvider::class.java).apply {
        action = ACTION_CLICK
      }
    val showDetailsPendingIntent =
