...
import xyz.stignarnia.uiProgress.calendar.views.CalendarFiltersView
import xyz.stignarnia.uiProgress.calendar.views.CalendarHeaderView
import xyz.stignarnia.uiProgress.calendar.views.CalendarItemView
...
class CalendarAdapter(
  ...
  override fun onCreateViewHolder(
    ...
    VIEW_TYPE_HEADER -> {
      BaseViewHolder(CalendarHeaderView(parent.context))
    }
