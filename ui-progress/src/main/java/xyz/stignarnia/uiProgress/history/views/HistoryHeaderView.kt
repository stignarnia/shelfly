package xyz.stignarnia.uiProgress.history.views
...
import xyz.stignarnia.uiProgress.databinding.ViewHistoryHeaderBinding
...
internal class HistoryHeaderView : FrameLayout {
  ...
  fun bind(
    ...
    with(binding) {
      text.text =
        if (now.dayOfYear == item.date.dayOfYear) {
