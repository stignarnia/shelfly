...
import xyz.stignarnia.uiPeople.list.recycler.views.PeopleListHeaderView
import xyz.stignarnia.uiPeople.list.recycler.views.PeopleListItemView
...
class PeopleListAdapter(
  ...
  override fun onCreateViewHolder(
    ...
    VIEW_TYPE_HEADER -> {
      BaseViewHolder(PeopleListHeaderView(parent.context))
    }
