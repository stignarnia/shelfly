...
@ViewModelScoped
class PersonDetailsCreditsCase
  @Inject
  constructor(
    ...
    suspend fun loadCredits(
      ...
      val (myShowsIds, myMoviesIds, watchlistShowsId, watchlistMoviesIds) =
        awaitAll(
          myShowsIdsAsync,
          myMoviesIdsAsync,
    ...
    private suspend fun createShowItem(
      ...
      val translation =
        when (val language = translationsRepository.getLanguage()) {
