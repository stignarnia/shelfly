...
import xyz.stignarnia.uiPeople.details.recycler.views.PersonDetailsBioView
import xyz.stignarnia.uiPeople.details.recycler.views.PersonDetailsCreditsItemView
import xyz.stignarnia.uiPeople.details.recycler.views.PersonDetailsFiltersView
import xyz.stignarnia.uiPeople.details.recycler.views.PersonDetailsHeaderView
import xyz.stignarnia.uiPeople.details.recycler.views.PersonDetailsInfoView
import xyz.stignarnia.uiPeople.details.recycler.views.PersonDetailsLoadingView
...
class PersonDetailsAdapter(
  ...
  override fun onCreateViewHolder(
    ...
    VIEW_TYPE_BIO -> {
      BaseViewHolder(PersonDetailsBioView(parent.context))
    }

    VIEW_TYPE_CREDIT_ITEM -> {
      BaseViewHolder(
    ...
    VIEW_TYPE_CREDIT_HEADER -> {
      BaseViewHolder(PersonDetailsHeaderView(parent.context))
    }

    VIEW_TYPE_CREDIT_LOADING -> {
      BaseViewHolder(PersonDetailsLoadingView(parent.context))
    }

    VIEW_TYPE_CREDIT_FILTERS -> {
      BaseViewHolder(
