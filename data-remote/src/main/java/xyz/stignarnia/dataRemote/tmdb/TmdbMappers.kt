...
import xyz.stignarnia.dataRemote.catalog.model.AirTime
...
import xyz.stignarnia.dataRemote.tmdb.model.TmdbEpisode
...
import xyz.stignarnia.dataRemote.tmdb.model.TmdbVideos
...
internal fun TmdbShow.toShow(): Show =
  Show(
    ...
    comment_count = null,
    genres =
      genres?.mapNotNull { it.name?.lowercase() }
