...
object Config {
  ...
  // private.omdbapi.com only accepts OMDb's Patreon-tier keys and rejects every
  // other key as invalid. Upstream Showly shipped a patron key; this fork asks
  // users for their own, which are almost always free-tier and www-only.
