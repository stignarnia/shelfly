package xyz.stignarnia.ui_settings.sections.spoilers.movies
...
import xyz.stignarnia.ui_base.utilities.extensions.setCheckedSilent
import xyz.stignarnia.ui_base.utilities.viewBinding
import xyz.stignarnia.ui_settings.R
import xyz.stignarnia.ui_settings.SettingsFragment.Companion.REQUEST_SETTINGS
import xyz.stignarnia.ui_settings.databinding.SheetSpoilersMoviesBinding
  ...
  private fun render(uiState: SpoilersMoviesUiState) {
    uiState.settings.run {
      with(binding) {
        ...
        notCollectedMoviesRatingsSwitch.setCheckedSilent(
          isNotCollectedMoviesRatingsHidden,
          notCollectedMoviesRatingsListener,
        )
