...
import xyz.stignarnia.uiMyMovies.mymovies.views.MyMovieAllView
import xyz.stignarnia.uiMyMovies.mymovies.views.MyMovieHeaderView
import xyz.stignarnia.uiMyMovies.mymovies.views.MyMoviesRecentsView
...
class MyMoviesAdapter(
  ...
  override fun onCreateViewHolder(
    ...
    VIEW_TYPE_HEADER -> {
      BaseViewHolder(MyMovieHeaderView(parent.context))
    }

    VIEW_TYPE_RECENTS_SECTION -> {
      BaseViewHolder(MyMoviesRecentsView(parent.context))
    }
  ...
  override fun onBindViewHolder(
    ...
    when (holder.itemViewType) {
      VIEW_TYPE_HEADER -> {
        (holder.itemView as MyMovieHeaderView).bind(
          item.header!!,
          listViewMode,
      ...
      VIEW_TYPE_RECENTS_SECTION -> {
        (holder.itemView as MyMoviesRecentsView).bind(
          item.recentsSection!!,
          itemClickListener,
