...
import xyz.stignarnia.uiLists.databinding.FragmentListDetailsBinding
import xyz.stignarnia.uiLists.details.helpers.ListItemDragListener
import xyz.stignarnia.uiLists.details.helpers.ListItemSwipeListener
import xyz.stignarnia.uiLists.details.helpers.ReorderListCallback
import xyz.stignarnia.uiLists.details.helpers.ReorderListCallbackAdapter
import xyz.stignarnia.uiLists.details.recycler.ListDetailsAdapter
import xyz.stignarnia.uiLists.details.recycler.ListDetailsItem
import xyz.stignarnia.uiLists.details.recycler.helpers.ListDetailsLayoutManagerProvider
import xyz.stignarnia.uiLists.details.recycler.helpers.ListDetailsListItemDecoration
...
class ListDetailsFragment :
  ...
  private fun setupRecycler() {
    layoutManager =
      ListDetailsLayoutManagerProvider
  ...
  private fun render(uiState: ListDetailsUiState) {
    fun renderTitle(
      ...
      binding.fragmentListDetailsToolbar.title =
        when {
