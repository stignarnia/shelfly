package xyz.stignarnia.uiDiscoverMovies.filters.views
...
import xyz.stignarnia.uiDiscoverMovies.databinding.ViewDiscoverMoviesFiltersBinding
...
class DiscoverMoviesFiltersView : FrameLayout {
  ...
  private fun bindProviders(providers: List<StreamingProvider>) {
    with(binding) {
      ...
      discoverMoviesProvidersChip.text =
        when {
          providers.isEmpty() -> {
