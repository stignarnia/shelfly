...
@HiltViewModel
internal class DiscoverMoviesFiltersProvidersViewModel @Inject constructor(
  ...
  fun saveProviders(providers: List<StreamingProvider>) {
    viewModelScope.launch {
      ...
      settingsRepository.filters.discoverMoviesProviders = providers
  ...
  val uiState = combine(
    ...
    initialValue = DiscoverMoviesFiltersProvidersUiState(),
  )
}
