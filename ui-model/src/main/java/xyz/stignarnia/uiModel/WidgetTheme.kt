 ...
 *
 * The entries after [FOLLOW_APP] are the app's own themes, and their names are deliberately the ids AppTheme persists - see xyz.stignarnia.uiSettings.helpers.AppTheme - so a widget's choice and the app's choice can be compared and mapped as strings.
